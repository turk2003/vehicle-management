 ...
 * User กดคืนรถ — บันทึกเลขไมล์สิ้นสุด + เปลี่ยนสถานะ
 */
  ...
  try {
    ...
    await prisma.log.create({
      data: {
        ...
        action: `User returned vehicle ${booking.vehicle.plateNumber} for booking ${bookingId}, mileage: ${mileageEnd} km, distance: ${distance} km`
      }
    })
